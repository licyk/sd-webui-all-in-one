...
$script:INVOKEAI_INSTALLER_VERSION = 483
$script:UPDATE_TIME_SPAN = 3600
# SD WebUI All In One 内核最低版本
$script:CORE_MINIMUM_VER = "2.2.52"
# 快照重建模式
$script:SnapshotExpectedWebUIType = "invokeai"
$script:SnapshotRestoreCliName = "invokeai"
$script:SnapshotRestorePathArgument = "--invokeai-path"
$script:SnapshotDisplayName = "InvokeAI"
$script:SnapshotRequiresGitKernel = $false
# PATH
& {
