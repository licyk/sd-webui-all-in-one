...
$script:SD_TRAINER_SCRIPT_INSTALLER_VERSION = 278
...
1. 使用的安装器 (例如: SD Trainer Script Installer)
2. 问题的详细描述
3. 复现问题的具体步骤
4. 附上本日志文件
...
SD Trainer Script Installer 版本: `$script:SD_TRAINER_SCRIPT_INSTALLER_VERSION
