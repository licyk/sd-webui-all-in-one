...
$SD_WEBUI_INSTALLER_VERSION = 177
...
function Check-Install {
    ...
    # SD WebUI Forge / SD WebUI reForge 安装的扩展
    if (((Test-Path "$PSScriptRoot/install_sd_webui_forge.txt") -or ($InstallBranch -eq "sd_webui_forge")) -or ((Test-Path "$PSScriptRoot/install_sd_webui_reforge.txt") -or ($InstallBranch -eq "sd_webui_reforge"))) {
