...
- [使用](#使用)
  ...
  - [更新 InvokeAI 管理脚本](#更新-invokeai-管理脚本)
    ...
    - [运行 InvokeAI Installer 进行更新](#运行-invokeai-installer-进行更新)
    - [使用命令更新](#使用命令更新)
...
>3. 该设置可通过[管理 InvokeAI Installer 设置](#管理-invokeai-installer-设置)中提到的的`settings.ps1`进行修改。
