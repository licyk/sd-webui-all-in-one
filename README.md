...
- [invokeai_installer.ps1](https://github.com/licyk/sd-webui-all-in-one/raw/main/invokeai_installer.ps1)：Windows 平台一键部署 [InvokeAI](https://github.com/invoke-ai/InvokeAI) 脚本。更多信息可[点击此处](./invokeai_installer.md)。
- [sd_trainer_installer.ps1](https://github.com/licyk/sd-webui-all-in-one/raw/main/sd_trainer_installer.ps1)：Windows 平台一键部署 [SD-Trainer](https://github.com/Akegarasu/lora-scripts) 脚本。更多信息可[点击此处](./sd_trainer_installer.md)。