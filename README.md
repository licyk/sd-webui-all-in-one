...
>4. Windows 用户可使用下载器进行下载，下载器地址：[下载地址 1](https://github.com/licyk/sd-webui-all-in-one/releases/download/portable/sd_portable_downloader.bat) / [下载地址 2](https://gitee.com/licyk/sd-webui-all-in-one/releases/download/archive/sd_portable_downloader.bat)
