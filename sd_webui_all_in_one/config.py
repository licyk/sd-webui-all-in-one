...
LOGGER_NAME = os.getenv("MANAGER_LOGGER_NAME", "Manager")
"""日志器名字"""

LOGGER_LEVEL = int(os.getenv("MANAGER_LOGGER_LEVEL", str(logging.INFO)))
"""日志等级"""

LOGGER_COLOR = os.getenv("MANAGER_LOGGER_COLOR") in ["1", "true", "True"]
"""日志颜色"""
