...
PYTORCH_DOWNLOAD_DICT: PyTorchVersionInfoList = [
    ...
    },
    {
        ...
        "index_mirror": {
            ...
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu132"][0]],
        },
        "extra_index_mirror": {
            "official": [],
            "mirror": [],
    ...
    },
    {
        ...
        "dtype": "all",
        "platform": ["win32", "linux", "darwin"],
        "torch_ver": "torch==2.12.1 torchvision==0.27.1 torchaudio==2.11.0",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYPI_INDEX_MIRROR_OFFICIAL],
            "mirror": [PYPI_INDEX_MIRROR_TENCENT],
    ...
    {
        "name": "Torch 2.12.1 (CPU)",
        "dtype": "cpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.12.1+cpu torchvision==0.27.1+cpu torchaudio==2.11.0+cpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cpu"][0]],
    ...
    {
        "name": "Torch 2.12.1 (ROCm 7.1) + xFormers 0.0.35",
        "dtype": "rocm7.1",
        "platform": ["linux"],
        "torch_ver": "torch==2.12.1+rocm7.1 torchvision==0.27.1+rocm7.1 torchaudio==2.11.0+rocm7.1",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.1"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.1"][0]],
    ...
    {
        "name": "Torch 2.12.1 (ROCm 7.2) + xFormers 0.0.35",
        "dtype": "rocm7.2",
        "platform": ["linux"],
        "torch_ver": "torch==2.12.1+rocm7.2 torchvision==0.27.1+rocm7.2 torchaudio==2.11.0+rocm7.2",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.2"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.2"][0]],
    ...
    {
        "name": "Torch 2.12.1 (XPU)",
        "dtype": "xpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.12.1+xpu torchvision==0.27.1+xpu torchaudio==2.11.0+xpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["xpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["xpu"][0]],
    ...
    {
        "name": "Torch 2.12.1 (CUDA 12.6) + xFormers 0.0.35",
        "dtype": "cu126",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.12.1+cu126 torchvision==0.27.1+cu126 torchaudio==2.11.0+cu126",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu126"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu126"][0]],
    ...
    {
        "name": "Torch 2.12.1 (CUDA 13.0) + xFormers 0.0.35",
        "dtype": "cu130",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.12.1+cu130 torchvision==0.27.1+cu130 torchaudio==2.11.0+cu130",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu130"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu130"][0]],
    ...
    {
        "name": "Torch 2.12.1 (CUDA 13.2)",
        "dtype": "cu132",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.12.1+cu132 torchvision==0.27.1+cu132",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu132"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu132"][0]],
    ...
    },
    {
        ...
        "dtype": "all",
        "platform": ["win32", "linux", "darwin"],
        "torch_ver": "torch==2.13.0 torchvision==0.28.0 torchaudio==2.11.0",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYPI_INDEX_MIRROR_OFFICIAL],
            "mirror": [PYPI_INDEX_MIRROR_TENCENT],
    ...
    {
        "name": "Torch 2.13.0 (CPU)",
        "dtype": "cpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.13.0+cpu torchvision==0.28.0+cpu torchaudio==2.11.0+cpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cpu"][0]],
    ...
    {
        "name": "Torch 2.13.0 (ROCm 7.1) + xFormers 0.0.35",
        "dtype": "rocm7.1",
        "platform": ["linux"],
        "torch_ver": "torch==2.13.0+rocm7.1 torchvision==0.28.0+rocm7.1 torchaudio==2.11.0+rocm7.1",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.1"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.1"][0]],
    ...
    {
        "name": "Torch 2.13.0 (ROCm 7.2) + xFormers 0.0.35",
        "dtype": "rocm7.2",
        "platform": ["linux"],
        "torch_ver": "torch==2.13.0+rocm7.2 torchvision==0.28.0+rocm7.2 torchaudio==2.11.0+rocm7.2",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.2"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.2"][0]],
    ...
    {
        "name": "Torch 2.13.0 (XPU)",
        "dtype": "xpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.13.0+xpu torchvision==0.28.0+xpu torchaudio==2.11.0+xpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["xpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["xpu"][0]],
    ...
    {
        "name": "Torch 2.13.0 (CUDA 12.6) + xFormers 0.0.35",
        "dtype": "cu126",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.13.0+cu126 torchvision==0.28.0+cu126 torchaudio==2.11.0+cu126",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu126"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu126"][0]],
    ...
    {
        "name": "Torch 2.13.0 (CUDA 13.0) + xFormers 0.0.35",
        "dtype": "cu130",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.13.0+cu130 torchvision==0.28.0+cu130 torchaudio==2.11.0+cu130",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu130"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu130"][0]],
    ...
    {
        "name": "Torch 2.13.0 (CUDA 13.2)",
        "dtype": "cu132",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.13.0+cu132 torchvision==0.28.0+cu132",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu132"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu132"][0]],
    ...
    },
    {
        ...
        "dtype": "all",
        "platform": ["win32", "linux", "darwin"],
        "torch_ver": "torch==2.14.0 torchvision==0.29.0 torchaudio==2.11.0",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYPI_INDEX_MIRROR_OFFICIAL],
            "mirror": [PYPI_INDEX_MIRROR_TENCENT],
    ...
    },
    {
        ...
        "dtype": "cpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.14.0+cpu torchvision==0.29.0+cpu torchaudio==2.11.0+cpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cpu"][0]],
    ...
    {
        "name": "Torch 2.14.0 (ROCm 7.14)",
        "dtype": "rocm7.14",
        "platform": ["linux"],
        "torch_ver": "torch==2.14.0+rocm7.14 torchvision==0.29.0+rocm7.14",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.14"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.14"][0]],
        },
        "extra_index_mirror": {
            "official": [],
            "mirror": [],
    ...
    {
        "name": "Torch 2.14.0 (ROCm 7.2) + xFormers 0.0.35",
        "dtype": "rocm7.2",
        "platform": ["linux"],
        "torch_ver": "torch==2.14.0+rocm7.2 torchvision==0.29.0+rocm7.2 torchaudio==2.11.0+rocm7.2",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["rocm7.2"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["rocm7.2"][0]],
    ...
    },
    {
        ...
        "dtype": "xpu",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.14.0+xpu torchvision==0.29.0+xpu torchaudio==2.11.0+xpu",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["xpu"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["xpu"][0]],
    ...
    {
        "name": "Torch 2.14.0 (CUDA 12.6) + xFormers 0.0.35",
        "dtype": "cu126",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.14.0+cu126 torchvision==0.29.0+cu126 torchaudio==2.11.0+cu126",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu126"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu126"][0]],
    ...
    {
        "name": "Torch 2.14.0 (CUDA 13.0) + xFormers 0.0.35",
        "dtype": "cu130",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.14.0+cu130 torchvision==0.29.0+cu130 torchaudio==2.11.0+cu130",
        "xformers_ver": "xformers==0.0.35",
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu130"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu130"][0]],
    ...
    {
        "name": "Torch 2.14.0 (CUDA 13.2)",
        "dtype": "cu132",
        "platform": ["win32", "linux"],
        "torch_ver": "torch==2.14.0+cu132 torchvision==0.29.0+cu132",
        "xformers_ver": None,
        "index_mirror": {
            "official": [PYTORCH_MIRROR_DICT["cu132"][0]],
            "mirror": [PYTORCH_MIRROR_NJU_DICT["cu132"][0]],
