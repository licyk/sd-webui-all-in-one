...
def prepare_fooocus_launch(
    ...
    Returns:
        WebUiLaunchInfo: Fooocus 启动参数信息。
    """
...
def launch_fooocus(
    ...
    Args:
        ...
        enable_hotpatcher_runtime (bool):
            是否启用补丁系统 runtime host 连接
    """
    launch_info = prepare_fooocus_launch(
        fooocus_path=fooocus_path,
...
def launch_fooocus_snapshot_gui(
    fooocus_path: Path,
    ...
    launch_snapshot_manager_gui(
        ...
        webui_type="fooocus",
        webui_path=fooocus_path,
        snapshot_factory=lambda include_packages: get_fooocus_snapshot(fooocus_path, include_packages=include_packages),
