...
from sd_webui_all_in_one.base_manager.invokeai_base.lifecycle import INVOKEAI_RUNNER_SCRIPT
from sd_webui_all_in_one.base_manager.invokeai_base.shared import logger


def prepare_invokeai_launch(
    invokeai_path: Path,
    ...
    Returns:
        WebUiLaunchInfo: InvokeAI 启动参数信息。
    """
...
def launch_invokeai(
    ...
    Raises:
        WebUiRuntimeError:
            InvokeAI 运行发生错误时抛出。
    """
    launch_info = prepare_invokeai_launch(
