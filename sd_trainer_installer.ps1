...
$SD_TRAINER_INSTALLER_VERSION = 144
...
- 28、Torch 2.5.1 (CUDA 11.8)
- 29、Torch 2.5.1 (CUDA 12.1)
...
-----------------------------------------------------
    ...
    while (`$True) {
        ...
        switch (`$arg) {
            ...
            28 {
                `$torch_ver = `"torch==2.5.1+cu118 torchvision==0.20.0+cu118 torchaudio==2.5.1+cu118`"
                `$xformers_ver = `"`"
                `$Env:PIP_EXTRA_INDEX_URL = `"`$PIP_EXTRA_INDEX_MIRROR `$PIP_EXTRA_INDEX_MIRROR_PYTORCH`"
                `$Env:UV_EXTRA_INDEX_URL = `"`$PIP_EXTRA_INDEX_MIRROR_PYTORCH`"
                `$Env:PIP_FIND_LINKS = `" `"
            ...
            29 {
                `$torch_ver = `"torch==2.5.1+cu121 torchvision==0.20.0+cu121 torchaudio==2.5.1+cu121`"
                `$xformers_ver = `"`"
                `$Env:PIP_EXTRA_INDEX_URL = `"`$PIP_EXTRA_INDEX_MIRROR `$PIP_EXTRA_INDEX_MIRROR_CU121`"
                `$Env:UV_EXTRA_INDEX_URL = `"`$PIP_EXTRA_INDEX_MIRROR_CU121`"
                `$Env:PIP_FIND_LINKS = `" `"
            ...
            30 {
                `$torch_ver = `"torch==2.5.1+cu124 torchvision==0.20.0+cu124 torchaudio==2.5.1+cu124`"
