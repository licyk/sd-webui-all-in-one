...
这个板块面向项目维护者和贡献者，用来记录 `sd_webui_all_in_one/`、`installer/`、`notebook/` 三块核心代码的架构、编码约定和验证方式。它不替代用户文档，而是帮助后续维护时快速判断“改哪里、同步哪里、怎么检查”。
...
2. 按要维护的区域阅读 [Python 内核](./python-core.md)、[Installer](./installer.md) 或 [Notebook](./notebook.md)。
