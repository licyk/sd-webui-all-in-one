...
## 简介
基于 [sd-webui-all-in-one/Installer](../installer/index.md) 全自动构建的整合包。可以使用 [AI 整合包下载器](../tools/portable-downloader.md) 下载并自动解压；解压后既可以直接运行包内脚本，也可以用 [Windows GUI Launcher](../tools/launcher-gui.md) 将安装路径指向整合包目录来统一启动和管理。
...
如果希望使用 Launcher 管理整合包，在 Launcher 中选择对应 WebUI / 工具，并把安装路径设置为整合包解压目录。只要目录中存在安装器生成的管理脚本，Launcher 就可以运行启动、更新、终端、模型下载和版本管理等操作。
...
![Stable Diffusion WebUI 整合包预览](../assets/images/portable/portable/stable-diffusion-webui.png)
...
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Stable Diffusion WebUI`，并在高级选项中把安装路径指向 Stable Diffusion WebUI 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_webui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
![Stable Diffusion WebUI Forge 整合包预览](../assets/images/portable/portable/stable-diffusion-webui-forge.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Stable Diffusion WebUI`，并在高级选项中把安装路径指向 Stable Diffusion WebUI Forge 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_webui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
![Stable Diffusion WebUI reForge 整合包预览](../assets/images/portable/portable/stable-diffusion-webui-reforge.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Stable Diffusion WebUI`，并在高级选项中把安装路径指向 Stable Diffusion WebUI reForge 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_webui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
![Stable Diffusion WebUI Forge Classic 整合包预览](../assets/images/portable/portable/stable-diffusion-webui-forge-classic.png)
...
## SD Next
![SD Next 整合包预览](../assets/images/portable/portable/sd-next.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Stable Diffusion WebUI`，并在高级选项中把安装路径指向 SD Next 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_webui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
## ComfyUI
![ComfyUI 整合包预览](../assets/images/portable/portable/comfyui.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `ComfyUI`，并在高级选项中把安装路径指向 ComfyUI 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `comfyui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
## Fooocus
![Fooocus 整合包预览](../assets/images/portable/portable/fooocus.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Fooocus`，并在高级选项中把安装路径指向 Fooocus 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `fooocus`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
## InvokeAI
![InvokeAI 整合包预览](../assets/images/portable/portable/invokeai.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `InvokeAI`，并在高级选项中把安装路径指向 InvokeAI 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `invokeai`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。


## SD-Trainer
![SD Trainer 整合包预览](../assets/images/portable/portable/sd-trainer.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `SD Trainer`，并在高级选项中把安装路径指向 SD-Trainer 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_trainer`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
## Kohya GUI
![Kohya GUI 整合包预览](../assets/images/portable/portable/kohya-gui.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `SD Trainer`，并在高级选项中把安装路径指向 Kohya GUI 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_trainer`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `SD Trainer Script`，并在高级选项中把安装路径指向 SD Scripts 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_trainer_script`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `SD Trainer Script`，并在高级选项中把安装路径指向 Musubi Tuner 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `sd_trainer_script`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。


## Qwen TTS WebUI
![Qwen TTS WebUI 整合包预览](../assets/images/portable/portable/qwen-tts-webui.png)
...
### SD WebUI All In One Launcher 管理方式
使用 [Windows GUI Launcher](../tools/launcher-gui.md) 时，在软件选择中选择 `Qwen TTS WebUI`，并在高级选项中把安装路径指向 Qwen TTS WebUI 整合包解压目录。使用 [Bash TUI / CLI Launcher](../tools/launcher-tui.md) 时，选择项目 `qwen_tts_webui`，将 `INSTALL_PATH` 指向整合包解压目录，再通过 `manage` / `run-script` 运行管理脚本。
