# SD Trainer Script Installer 安装
...
!!! note
    ...
    2. SD Trainer Script Installer 支持使用在命令行中通过参数配置 SD-Trainer-Script 的安装参数，具体说明可阅读 [使用命令运行 SD Trainer Script Installer](advanced.md#使用命令运行-sd-trainer-script-installer)。
