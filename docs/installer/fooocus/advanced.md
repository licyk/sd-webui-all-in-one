...
### 创建快捷启动方式
!!! info
    该设置可通过 [管理 Fooocus Installer 设置](config.md#管理-fooocus-installer-设置) 中提到的的 `settings.ps1` 进行修改。
...
构建模式需要使用命令行参数进行启用，具体可阅读 [使用命令运行 Fooocus Installer](advanced.md#使用命令运行-fooocus-installer) 中的参数说明。
